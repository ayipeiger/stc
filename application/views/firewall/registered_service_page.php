	...
	<div class="content">
		<div class="main-content">
    		<table id="tableData" class="table table-striped table-bordered" style="font-size: 12px; width:100%;">
				...
				<tbody>
                    <?php if(isset($arrFirewallService) && is_array($arrFirewallService) && count($arrFirewallService) > 0): ?>
						<?php if(is_array($arrFirewallService) && count($arrFirewallService)>0): ?>
							<?php foreach($arrFirewallService as $firewallServiceObj): ?>
								<tr>
									<td align="right"><?=$firewallServiceObj->getPortname()?></td>
									<td align="right"><?=$firewallServiceObj->getProtocol()?></td>
									<td align="center"><?=$firewallServiceObj->getPortAddress()?></td>
								</tr>
							<?php endforeach?>
						<?php endif; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="3" align="center">Data is empty</td>
                        </tr>
                    <?php endif; ?>
				</tbody>
				<thead>
